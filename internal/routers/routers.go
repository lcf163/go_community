...
func SetupRouter(mode string) *gin.Engine {
	...
	// 设置 Swagger Host
	docs.SwaggerInfo.Host = global.Conf.GetSwaggerHost()
	...
	// )
	r.Use(middlewares.GinLogger(), middlewares.GinRecovery(true)) // Recovery 中间件：recover 项目可能出现的 panic，并使用 zap 记录相关日志
